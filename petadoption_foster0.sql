...
CREATE TABLE `foster` (
  ...
  `FOSTER_NAME` varchar(40) NOT NULL,
  `FOSTER_ADDRESS` varchar(100) NOT NULL,
  `FOSTER_PHONE` varchar(14) NOT NULL,
  `AGENCY_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`FOSTER_ID`),
  KEY `AGENCY_ID` (`AGENCY_ID`),
  CONSTRAINT `foster_ibfk_1` FOREIGN KEY (`AGENCY_ID`) REFERENCES `agency` (`AGENCY_ID`)
...
-- Dump completed on 2019-10-03 17:17:48
